...
class _$PackageVersionImpl implements _PackageVersion {
  _$PackageVersionImpl({required this.version, required this.pubspec});
  ...
  @override
  String toString() {
    return 'PackageVersion(version: $version, pubspec: $pubspec)';
  }
...
abstract class _PackageVersion implements PackageVersion {
  factory _PackageVersion(
      ...
      required final Pubspec pubspec}) = _$PackageVersionImpl;
